...
def attention_distribution_map(
        attention=None,
        tokens=None,
    ...
    """Render attention distribution map
    ...
    if html_action == 'view':
        ...
        vis_js = open(os.path.join(__location__, 'attention_distribution_map.js')).read().replace("PYTHON_PARAMS", json.dumps(params))
